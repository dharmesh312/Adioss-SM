...
class Inputform extends React.Component {
        constructor(props) {
          super(props);
            ...
            this.state = {
                  _id:'n/a' ,  name:'n/a', phone:'n/a', email:'n/a', gendervalue:'Male', date1:'n/a',dateofadmission:'n/a', classvalue:'n/a',sectionvalue:'n/a', nationality:'Indian',
                  address_line1:'n/a', address_line2:'n/a', address_City:'n/a', address_Pincode:'n/a', address_State: 'Rajasthan',
                  perm_address_line1:'n/a', perm_address_line2:'n/a', perm_address_City:'n/a', perm_address_Pincode:'n/a', perm_address_State: 'Rajasthan',father_age:'n/a',father_name:'n/a',father_qual:'n/a',father_email:'n/a',father_office:'n/a',father_mobile:'n/a',father_occupation:'n/a',
                  father_office_phone:'n/a',Mother_age:'n/a',Mother_name:'n/a',Mother_qual:'n/a',Mother_email:'n/a',Mother_office:'n/a',Mother_office_phone:'n/a',Mother_mobile:'n/a',
                  Mother_occupation:'n/a',lastclass:'n/a',lastclassmarks:'n/a',lastclasspercentage:'n/a',guardian:'n/a',guardian_relation:'n/a',Index: 1
                };
  ...
  handleClick = () => {
    console.log(this.state);
      var x=(this.state.name).toUpperCase()
    ...
    student_id_database.put({_id:this.state._id}).then( (response)=> {
          ...
          attendance_database_three_A.put({_id:this.state._id,dateofadmission:'n/a' ,name:this.state.name,class:this.state.classvalue,section:this.state.sectionvalue,attendence:'n/a'});
          feepay_database.put({_id:this.state._id,name:this.state.name,class:this.state.classvalue,section:this.state.sectionvalue,totalFee:0,totalFeePaid:0,feeCycle:'n/a',dateOfPayment:{_id: new Date().toISOString(), feepaid:0}});
          student_database_one.put(this.state);
          subjectclass_database.put({_id:this.state._id,name:this.state.name,class:this.state.classvalue,section:this.state.sectionvalue,subject:'n/a'});
...
handlegender = (value) => {
  ...
  address = {line1:'n/a', line2:'n/a', City:'n/a',Pincode:'n/a', State:'n/a'};
  handleclass = (value) => {
  ...
  render () {
    return (<div style={{ flex: 1, overflowX: 'auto', margin: '5% 10% 10% 22%' }}>
      ...
      <section>
        ...
        <Card><Button  label='Add Student' raised primary onClick={this.handleClick} /></Card>
        </Tab>
        </Tabs>
