    ...
    return (<div style={{ flex: 1, overflowX: 'auto', margin: '5% 10% 10% 20%' }}>
      ...
      <section>
        ...
        <div style={{ flex: 1, overflowX: 'auto', padding: '1.8rem' }}>
         <Card><Button  label='Make BackUp' raised accent onClick={this.handleClick1} /></Card>
        <a href="#/Readmission"> <Card><Button  label='Start Readmission' raised primary onClick={this.handleClick} /></Card></a>
        </div>
      </section>
      </div>
    );
