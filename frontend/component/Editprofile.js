...
setTimeout(function(){ this.state._id = Id; this.forceUpdate() }.bind(this), 500);
  ...
  handleClick = () => {
    ...
    var nam=(this.state.name).toUpperCase()
    ...
    return (<div style={{ flex: 1, overflowX: 'auto', margin: '5% 10% 10% 20%' }}>
      ...
      <section>
        ...
        <div style={{ flex: 1, overflowX: 'auto', padding: '1.8rem' }}>
         <Card><Button  label='Save Changes' raised primary onClick={this.handleClick} /></Card>
         <Card><Button  label='Undo Changes' onClick={this.resetForm} accent raised/></Card>
        </div>
      </section>
      </div>
    );
